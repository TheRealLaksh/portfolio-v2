...
const AboutMeSection = () => {
  const profileImageUrl = Images.ProfilePlaceholder; // This image will need to be replaced in /lib/images.ts
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 lg:gap-16 items-start md:items-center">
          ...
          >
            ...
            <div className="relative aspect-[3/4] sm:aspect-square rounded-xl overflow-hidden border border-zinc-800 shadow-2xl group">
              <Image
                src={ profileImageUrl }
                alt="Laksh Pradhwani - Web Developer and AI/ML Engineer"
                layout="fill"
                objectFit="cover"
          ...
          <div className="space-y-6">
            <GlassmorphicCard>
              <p className="text-lg text-zinc-300 leading-relaxed lg:text-justify">
                As an aspiring AI/ML Engineer and high school student, my journey from a simple &quot;Hello, World!&quot; to building full-stack applications is driven by a passion for transforming creative ideas into tangible solutions. With a strong foundation in the <strong className="text-teal-400">MERN stack</strong>, I&apos;ve honed my skills through <strong className="font-semibold text-white">three internships</strong>, applying my technical knowledge to real-world projects.
              </p>
              <p className="text-lg text-zinc-300 mt-4 leading-relaxed lg:text-justify">
                I thrive on solving complex problems, a skill sharpened through consistent success in tech competitions, including winning multiple <strong className="font-semibold text-white">hackathons</strong> and being a top performer in the <strong className="font-semibold text-white">VVM National Science Competition</strong>. My experience as House Captain and in competitive sports has instilled in me a disciplined, goal-oriented approach.
              </p>
              <p className="text-lg text-zinc-300 mt-4 leading-relaxed lg:text-justify">
                When I&apos;m not coding, I enjoy contributing to open-source projects and attending insightful and informative workshops. I am actively seeking new internship opportunities to contribute to innovative projects and continue my growth.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 mt-8 pt-6 border-t border-zinc-700/50">
                <div>
                  ...
                  <div className="font-medium text-zinc-200">Laksh Pradhwani</div>
                </div>
                <div>
                  <div className="text-xs sm:text-sm text-white/90">Email</div>
                  <Link href="mailto:laksh.pradhwani@Gmail.com" className="font-medium text-zinc-200 hover:text-teal-400 transition-colors">
                    laksh.pradhwani@Gmail.com
                  </Link>
                </div>
                <div>
                  <div className="text-xs sm:text-sm text-white/90">Location</div>
                  <div className="font-medium text-zinc-200">Varanasi, Uttar Pradesh, India</div>
                </div>
                <div>
                  <div className="text-xs sm:text-sm text-white/90">Availability</div>
                  <div className="font-medium text-green-400">Open to Freelancing</div>
                </div>
              </div>
            </GlassmorphicCard>
          </div>
