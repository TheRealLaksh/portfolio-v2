...
const Contact = () => {
  ...
  return (
    <section id="contact" className="my-16 sm:my-24 scroll-mt-20 relative z-10" data-aos="fade-up">
      <div className="w-full px-6 md:px-12 max-w-[1400px] mx-auto">

        <h2 className="section-title text-3xl font-bold text-white text-center mb-12 relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-slate-900/50 backdrop-blur-md border border-slate-800 p-6 rounded-2xl shadow-lg flex flex-col sm:flex-row justify-between items-center gap-4">
              ...
              <div className="flex flex-wrap gap-4">
                {/* GitHub */}
                <a href="https://github.com/TheRealLaksh" target="_blank" aria-label="GitHub" rel="noreferrer"
                  className="group relative flex items-center justify-start w-12 hover:w-32 h-12 bg-slate-800 rounded-xl border border-slate-700 overflow-hidden transition-all duration-500 ease-out hover:border-slate-500 hover:bg-slate-700">
                  <div className="w-12 h-12 flex items-center justify-center shrink-0 z-10 text-slate-400 group-hover:text-white transition-colors duration-300">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/in/laksh-pradhwani" target="_blank" aria-label="LinkedIn" rel="noreferrer"
                  className="group relative flex items-center justify-start w-12 hover:w-36 h-12 bg-slate-800 rounded-xl border border-slate-700 overflow-hidden transition-all duration-500 ease-out hover:border-blue-500/50 hover:bg-blue-900/20">
                  <div className="w-12 h-12 flex items-center justify-center shrink-0 z-10 text-slate-400 group-hover:text-blue-400 transition-colors duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/_.lakshp/" target="_blank" aria-label="Instagram" rel="noreferrer"
                  className="group relative flex items-center justify-start w-12 hover:w-36 h-12 bg-slate-800 rounded-xl border border-slate-700 overflow-hidden transition-all duration-500 ease-out hover:border-pink-500/50 hover:bg-pink-900/20">
                  <div className="w-12 h-12 flex items-center justify-center shrink-0 z-10 text-slate-400 group-hover:text-pink-400 transition-colors duration-300">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="lg:col-span-3">
            <form onSubmit={handleSubmit} className="bg-slate-900/30 backdrop-blur-md border border-slate-800/50 p-8 rounded-2xl shadow-xl relative group overflow-hidden">
