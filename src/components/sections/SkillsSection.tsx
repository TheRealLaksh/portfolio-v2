...
const skillCategories = [
  ...
  },
  {
    ...
    skills: [
      {
        name: "Kali Linux",
        icon: <SiKalilinux className="h-8 w-8 text-[#557C94]" />,
      },
      {
        name: "Penetration Testing",
        icon: <FaShieldAlt className="h-8 w-8 text-[#DC2626]" />,
      },
      {
        name: "Digital Forensics",
        icon: <FaSearch className="h-8 w-8 text-[#60A5FA]" />,
      },
      {
        name: "Vibe Coding",
        icon: <IoSparkles className="h-8 w-8 text-[#F472B6]" />,
      },
    ],
  },
];
...
const itemVariants = {
  ...
  visible: (index: number) => ({
    // <-- Added index for staggered delay
    opacity: 1,
    y: 0,
    transition: {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(400px circle at var(--mouse-x) var(--mouse-y), rgba(56, 189, 248, 0.15), transparent 80%)",
        }}
      />
...
export default function SkillsSection() {
  return (
    <section
      id="skills"
      className="py-24 sm:py-32 relative bg-gray-950 overflow-hidden"
    >
