...
const Hero = () => {
  ...
  return (
    <section ref={containerRef} id="home" className="min-h-screen flex flex-col justify-center relative z-10 px-4 sm:px-0 perspective-[1200px] overflow-hidden">
      ...
      >
        ...
        <Parallax speed={-0.15} className="mb-6">
          {/* Interactive Scramble Title */}
          <h1 
            className="text-6xl sm:text-8xl font-extrabold text-white tracking-tight drop-shadow-2xl cursor-pointer font-mono"
        ...
        {/* ... (Buttons and Social Links remain unchanged) ... */}
        ...
        <div className="flex flex-wrap justify-center items-center gap-4 mt-8">
             ...
             {/* GitHub, LinkedIn, Instagram, Email - exactly as they were */}
