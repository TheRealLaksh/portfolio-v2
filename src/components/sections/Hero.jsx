...
import { triggerWarp } from '../../utils/triggerWarp'; // Import Warp Trigger
...
const Hero = () => {
  ...
  // Helper to handle navigation clicks with Warp effect
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center relative z-10 px-4 sm:px-0">
      <div className="w-full max-w-4xl mx-auto text-center">

        <h2 className="text-3xl sm:text-5xl font-bold text-slate-400 mb-8 h-[20px] sm:h-[20px]">
          Hello, I'm
        </h2>
        
        <h1 className="text-6xl sm:text-8xl font-extrabold text-white tracking-tight mb-6" data-aos="fade-up" data-aos-delay="100">
          Laksh Pradhwani.
        </h1>

        <h2 className="text-3xl sm:text-5xl font-bold text-slate-400 mb-8 h-[60px] sm:h-[80px]" data-aos="fade-up" data-aos-delay="200">
          <span ref={typedEl} id="typed-text" className="text-slate-300"></span>
        </h2>

        <p className="max-w-2xl mx-auto text-slate-400 text-lg leading-relaxed mb-10" data-aos="fade-up" data-aos-delay="300">
        ...
        {/* --- Action Buttons --- */}
        <div className="flex flex-wrap justify-center gap-6 mb-12" data-aos="fade-up" data-aos-delay="400">
        ...
        {/* --- Social Links (Inline) --- */}
        <div className="flex flex-wrap justify-center items-center gap-4 mt-8" data-aos="fade-up" data-aos-delay="400">
          ...
          <a href="https://github.com/TheRealLaksh" target="_blank" rel="noopener noreferrer" className="group relative flex items-center justify-start w-12 hover:w-32 h-12 bg-slate-800/50 border border-slate-700 rounded-full overflow-hidden transition-all duration-500 ease-out hover:border-green-500/50 shadow-lg hover:shadow-green-900/20">
            ...
            <span className="opacity-0 group-hover:opacity-100 text-green-400 font-medium text-sm whitespace-nowrap transition-all duration-500 delay-100 absolute left-12">
              GitHub
            </span>
          </a>
          ...
          <a href="https://www.linkedin.com/in/laksh-pradhwani" target="_blank" rel="noopener noreferrer" className="group relative flex items-center justify-start w-12 hover:w-36 h-12 bg-slate-800/50 border border-slate-700 rounded-full overflow-hidden transition-all duration-500 ease-out hover:border-blue-500/50 shadow-lg hover:shadow-blue-900/20">
            ...
            <span className="opacity-0 group-hover:opacity-100 text-blue-400 font-medium text-sm whitespace-nowrap transition-all duration-500 delay-100 absolute left-12">
              LinkedIn
            </span>
          </a>
          ...
          <a href="https://www.instagram.com/_.lakshp/" target="_blank" rel="noopener noreferrer" className="group relative flex items-center justify-start w-12 hover:w-36 h-12 bg-slate-800/50 border border-slate-700 rounded-full overflow-hidden transition-all duration-500 ease-out hover:border-pink-500/50 shadow-lg hover:shadow-pink-900/20">
            ...
            <span className="opacity-0 group-hover:opacity-100 text-pink-400 font-medium text-sm whitespace-nowrap transition-all duration-500 delay-100 absolute left-12">
              Instagram
            </span>
          </a>
          ...
          <a href="mailto:contact@lakshp.live" className="group relative flex items-center justify-start w-12 hover:w-32 h-12 bg-slate-800/50 border border-slate-700 rounded-full overflow-hidden transition-all duration-500 ease-out hover:border-rose-500/50 shadow-lg hover:shadow-rose-900/20">
            ...
            <span className="opacity-0 group-hover:opacity-100 text-rose-400 font-medium text-sm whitespace-nowrap transition-all duration-500 delay-100 absolute left-12">
              Email
            </span>
          </a>
